...
<section class="mt-4 pt-4 pb-4">
	...
	<div class="container">
		<div class="col-lg-12">
			...
			<input type="file" id="chooseFile" multiple="multiple" onchange="displayIMG(this)" accept="image/png,image/gif,image/jpeg" style="display: none">
			  <div id="drop">
  ...
  addEventHandler(window, 'load', function() {
    ...
    addEventHandler(drop, 'drop', function(e) {
      ...
      for (var i = 0; i < files.length; i++) {
        ...
        //attach event handlers here...   alert('submit ok');
